...
prompt for each profession lives on its page and is the reason to send a reader there.',
    ...
    // --- /sponsor ---
    'page.sponsor.pageTitle'       => 'Sponsor',
    'page.sponsor.pageDesc'        => 'Fixed-price placements on willaistealit.com. No subscriptions, no verdict influence, ever.',
    'page.sponsor.h1'              => 'Sponsor',
    'page.sponsor.lede'            => 'Not selling yet — traffic first. If you want one of the first slots, get on the list and you will hear from us before anyone else.',
    'page.sponsor.rule.h'          => 'The rule that comes first',
    'page.sponsor.rule.p1'         => '<strong>Sponsorship never touches a verdict.</strong> Sponsors do not see entries before publication, cannot request a change to one, and cannot buy a mention inside an entry. If a sponsor\'s own profession is on the site, its verdict is written exactly as if they were not paying. This is not negotiable, and any sponsor who asks is refunded and dropped.',
    'page.sponsor.rule.p2'         => 'The site is worth sponsoring precisely because people trust the verdicts. Selling that trust would destroy the thing you are buying access to.',
    'page.sponsor.fits.h'          => 'Who this fits',
    'page.sponsor.fits.p'          => 'Every visitor arrives asking whether their job is safe, and leaves looking for what to do about it. That makes this a natural fit for:',
    'page.sponsor.fits.reskilling' => '<strong>Reskilling and education platforms</strong> — the reader has just been told their role is narrowing and is actively looking for the next skill.',
    'page.sponsor.fits.tools'      => '<strong>AI tools</strong> — every entry ends with a prompt and a tool list. Readers are in "what do I use" mode.',
    'page.sponsor.fits.career'     => '<strong>Career and hiring platforms</strong> — the audience is mid-career professionals reconsidering their trajectory.',
    'page.sponsor.fits.saas'       => '<strong>Automation SaaS</strong> — the buyer is the person automating the tasks we just marked <code>going</code>.',
    'page.sponsor.how.h'           => 'How it will work',
    'page.sponsor.how.fixed'       => '<strong>Fixed price, one-off.</strong> A 30-day placement. No subscription, no auto-renewal, no invoice you forgot about.',
    'page.sponsor.how.slots'       => '<strong>8–10 slots, then it is full.</strong> Scarcity is the product; a wall of logos is worth nothing to anyone.',
    'page.sponsor.how.rate'        => '<strong>Your rate never rises.</strong> Prices go up as traffic does — but only for new sponsors. Whatever you pay first is what you keep paying.',
    'page.sponsor.how.plain'       => '<strong>Plain placements.</strong> Name, one line, link. No pop-ups, no interstitials, no tracking scripts we did not write.',
    'page.sponsor.today.h'         => 'Where it stands today',
    'page.sponsor.today.p'         => '%d published %s, growing weekly. Slots open once traffic is meaningful enough that a placement is actually worth your money. Until then this page sells nothing.',
    'page.sponsor.entry'           => 'entry',
    'page.sponsor.entries'         => 'entries',
    'page.sponsor.list.hSent'      => 'You are on the list',
    'page.sponsor.list.h'          => 'Get first refusal',
    'page.sponsor.list.sent'       => 'Noted — you will hear from us before slots go public. No newsletter, no drip sequence: one email, when there is something to sell.',
    'page.sponsor.list.p'          => 'Leave an email and we will contact you when slots open, before they are announced publicly. That is the entire commitment — no list, no newsletter.',
    'page.sponsor.list.label'      => 'Email address',
    'page.sponsor.list.submit'     => 'Join the list',
    'page.sponsor.list.note'       => 'Stored as a line in a file. Used for one thing: telling you when slots open.',
    'page.sponsor.err.email'       => 'That does not look like a working email address.',
    'page.sponsor.err.saveContact' => 'Could not save that — email %s instead.',
    'page.sponsor.err.save'        => 'Could not save that. Try again in a moment.',
    'page.sponsor.talk.h'          => 'Rather just talk?',
    'page.sponsor.talk.p'          => 'Write to %s with what you are selling and who you want to reach.',
];
