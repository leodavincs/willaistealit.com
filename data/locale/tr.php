...
kendi sayfasında durur ve okuru oraya göndermenin sebebi odur.',
    ...
    // --- /sponsor (sponsorluk) ---
    'page.sponsor.pageTitle'       => 'Sponsorluk',
    'page.sponsor.pageDesc'        => 'willaistealit.com üzerinde sabit fiyatlı yerleşimler. Abonelik yok, yargıya etki asla yok.',
    'page.sponsor.h1'              => 'Sponsorluk',
    'page.sponsor.lede'            => 'Henüz satmıyoruz — önce trafik. İlk yerlerden birini istiyorsanız listeye girin, herkesten önce sizi haberdar edelim.',
    'page.sponsor.rule.h'          => 'Her şeyden önce gelen kural',
    'page.sponsor.rule.p1'         => '<strong>Sponsorluk hiçbir yargıya dokunmaz.</strong> Sponsorlar entry\'leri yayından önce görmez, birinde değişiklik isteyemez ve bir entry\'nin içinde kendilerinden söz edilmesini satın alamaz. Bir sponsorun kendi mesleği sitedeyse, o mesleğin yargısı sanki para ödemiyorlarmış gibi yazılır. Bu pazarlığa açık değildir; isteyen sponsorun parası iade edilir ve ilişki biter.',
    'page.sponsor.rule.p2'         => 'Bu siteye sponsor olmak, tam da insanlar yargılara güvendiği için değerli. O güveni satmak, erişim satın aldığınız şeyi yok ederdi.',
    'page.sponsor.fits.h'          => 'Kime uygun',
    'page.sponsor.fits.p'          => 'Her ziyaretçi işinin güvende olup olmadığını sorarak geliyor ve ne yapacağını arayarak ayrılıyor. Bu da burayı şunlar için doğal bir yer yapıyor:',
    'page.sponsor.fits.reskilling' => '<strong>Yeniden beceri kazandırma ve eğitim platformları</strong> — okura rolünün daraldığı yeni söylendi ve bir sonraki beceriyi aktif olarak arıyor.',
    'page.sponsor.fits.tools'      => '<strong>Yapay zekâ araçları</strong> — her entry bir prompt ve araç listesiyle bitiyor. Okur "ne kullanayım" modunda.',
    'page.sponsor.fits.career'     => '<strong>Kariyer ve işe alım platformları</strong> — kitle, yönünü yeniden düşünen kariyer ortası profesyoneller.',
    'page.sponsor.fits.saas'       => '<strong>Otomasyon SaaS ürünleri</strong> — alıcı, az önce <code>gidiyor</code> diye işaretlediğimiz görevleri otomatikleştiren kişi.',
    'page.sponsor.how.h'           => 'Nasıl işleyecek',
    'page.sponsor.how.fixed'       => '<strong>Sabit fiyat, tek seferlik.</strong> 30 günlük yerleşim. Abonelik yok, otomatik yenileme yok, unuttuğunuz fatura yok.',
    'page.sponsor.how.slots'       => '<strong>8–10 yer, sonra dolu.</strong> Ürün kıtlığın kendisi; logo duvarının kimseye faydası yok.',
    'page.sponsor.how.rate'        => '<strong>Sizin fiyatınız hiç artmaz.</strong> Trafik arttıkça fiyatlar da artıyor — ama yalnızca yeni sponsorlar için. İlk ödediğiniz, ödemeye devam ettiğinizdir.',
    'page.sponsor.how.plain'       => '<strong>Sade yerleşimler.</strong> İsim, tek satır, bağlantı. Açılır pencere yok, ara sayfa yok, bizim yazmadığımız takip kodu yok.',
    'page.sponsor.today.h'         => 'Bugün durum ne',
    'page.sponsor.today.p'         => 'Yayında %d %s var ve her hafta artıyor. Yerler, bir yerleşimin paranıza gerçekten değeceği kadar trafik olduğunda açılacak. O zamana kadar bu sayfa hiçbir şey satmıyor.',
    'page.sponsor.entry'           => 'entry',
    'page.sponsor.entries'         => 'entry',
    'page.sponsor.list.hSent'      => 'Listedesiniz',
    'page.sponsor.list.h'          => 'İlk sırayı alın',
    'page.sponsor.list.sent'       => 'Not aldık — yerler herkese açılmadan önce sizi haberdar edeceğiz. Bülten yok, otomatik e-posta dizisi yok: satacak bir şey olduğunda tek bir e-posta.',
    'page.sponsor.list.p'          => 'Bir e-posta bırakın, yerler açıldığında herkese duyurulmadan önce size yazalım. Taahhüdün tamamı bu — liste yok, bülten yok.',
    'page.sponsor.list.label'      => 'E-posta adresi',
    'page.sponsor.list.submit'     => 'Listeye katıl',
    'page.sponsor.list.note'       => 'Bir dosyada tek satır olarak saklanıyor. Tek bir iş için kullanılıyor: yerler açıldığında size haber vermek.',
    'page.sponsor.err.email'       => 'Bu çalışan bir e-posta adresine benzemiyor.',
    'page.sponsor.err.saveContact' => 'Kaydedilemedi — bunun yerine %s adresine yazın.',
    'page.sponsor.err.save'        => 'Kaydedilemedi. Birazdan tekrar deneyin.',
    'page.sponsor.talk.h'          => 'Konuşmayı mı tercih edersiniz?',
    'page.sponsor.talk.p'          => 'Ne sattığınızı ve kime ulaşmak istediğinizi %s adresine yazın.',
];
